...
import me.szumielxd.proxyyweb.common.ClientIdManager;
import me.szumielxd.proxyyweb.common.PlayerInfoManager;
import me.szumielxd.proxyyweb.common.ServerIdManager;
import me.szumielxd.proxyyweb.common.commands.ReloadConfig;
import me.szumielxd.proxyyweb.common.hikari.HikariDB;
import me.szumielxd.proxyyweb.common.hikari.MariaDB;
import me.szumielxd.proxyyweb.common.hikari.MysqlDB;
...
public class BungeeWeb extends Plugin {
	...
	public void onEnable() {
		...
		this.databaseManager = (switch (getConfig().getString("database.mode", "MySQL").toLowerCase()) {
			case "mysql" -> new MysqlDB(this, hostName, dbName, dbProperties, dbUser, dbPasswd);
			default -> new MariaDB(this, hostName, dbName, dbProperties, dbUser, dbPasswd);
		}).setup();
		...
		setupPurging("log");
		setupPurging("client_stats");
		setupPurging("server_stats");
	...
	private void setupLocale(@NotNull String lang) {
	...
	private void setupDirectory(@NotNull String directory) {
	...
	private void setupPurging(@NotNull String type) {
