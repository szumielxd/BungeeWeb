...
public class MysqlDB<T> extends HikariDB<T> {

	public MysqlDB(ProxyyWeb<T, ?, ?> plugin, String host, String database, Map<String, String> properties, String user, String pass) {
	...
	protected void setupProperties(HikariConfig config, Map<String, String> properties) {
		...
		properties.putIfAbsent("socketTimeout", "6000000");
