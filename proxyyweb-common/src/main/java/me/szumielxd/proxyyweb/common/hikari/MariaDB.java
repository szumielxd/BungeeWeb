...
public class MariaDB<T> extends HikariDB<T> {

	public MariaDB(ProxyyWeb<T, ?, ?> plugin, String host, String database, Map<String, String> properties, String user, String pass) {
